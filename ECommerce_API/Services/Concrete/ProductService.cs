    ...
    public class ProductService : IProductService
    {
        ...
        public async Task<ServiceResponse<ProductDTO>> AddProduct(ProductDTO productDTO)
        {
            ...
            if(result == null)
            {
                ...
                {
                    Data = productDTO,
                    Messagge = " Product is added",
                    Success = true,
                };
            }
            return new ServiceResponse<ProductDTO>
            {
                Messagge = "Product Exist",
                Success = false,
        ...
        public async Task<ServiceResponse<IEnumerable<ProductDTO>>> GetAll()
        {
            ...
            return new ServiceResponse<IEnumerable<ProductDTO>> { Data = response };
        }
        ...
        public async Task<ServiceResponse<ProductDTO>> GetProduct(string productName)
        {
            ...
            return new ServiceResponse<ProductDTO> { Data = response };
        }
        ...
        public async Task<ServiceResponse<ProductSearchResult>> GetProducts(int page)
        {
            ...
            var product = await _context.Products.Skip((page-1)*(int)pageResults).Take((int)pageResults).ToListAsync();
        ...
        public async Task<ServiceResponse<List<Product>>> GetProductsByCategory(int categoryId)
        {
            ...
            if(result == null)
            {
                ...
                {
                    Messagge = "Product is not found",
                    Success = false,
                };
            }
            return new ServiceResponse<List<Product>> { Data = result,Success = true };
        }
